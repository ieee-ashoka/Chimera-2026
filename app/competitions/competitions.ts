    ...
    rounds: [
      {
        ...
        startDate: new Date(2026, 1, 16, 8, 0),
        endDate: new Date(2026, 1, 16, 9, 0),
      },
      {
        ...
        startDate: new Date(2026, 1, 16, 9, 15),
        endDate: new Date(2026, 1, 16, 10, 15),
      },
    ],
    judgingCriteria: [
      {
    ...
    rounds: [
      {
        ...
        startDate: new Date(2026, 1, 16, 8, 0),
        endDate: new Date(2026, 1, 16, 10, 0),
      },
      {
        ...
        startDate: new Date(2026, 1, 16, 10, 30),
        endDate: new Date(2026, 1, 16, 13, 0),
      },
      {
        title: "Presentation",
        ...
        startDate: new Date(2026, 1, 16, 13, 30),
        endDate: new Date(2026, 1, 16, 17, 0),
      },
    ],
    judgingCriteria: [
    ...
    rounds: [
      {
        ...
        startDate: new Date(2026, 1, 16, 8, 0),
        endDate: new Date(2026, 1, 16, 12, 0),
      },
      {
        ...
        startDate: new Date(2026, 1, 16, 12, 30),
        endDate: new Date(2026, 1, 16, 14, 30),
      },
      {
        ...
        startDate: new Date(2026, 1, 16, 15, 0),
        endDate: new Date(2026, 1, 16, 17, 0),
      },
    ],
    judgingCriteria: [
